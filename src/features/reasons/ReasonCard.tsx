...
export function ReasonCard({ reason }: Props) {
  return (
    <article className="flex flex-col gap-8 md:gap-16 rounded-xl bg-red p-8 text-white md:flex-row lg:items-start lg:justify-between">
